                    ...
                    >
                      ...
                      >
                        <img
                          ...
                          width="18px"
                          height="18px"
                          alt="icon" // don't forget alt attribute for accessibility
                        />
                      </Stack>
                    </Box>
                    <Box
                      sx={{
                        height: "60px", // Limit max height of the description
                        overflow: "auto", // Add scrollbar if the content exceeds maxHeight
                      }}
                    >
                      <Typography
                        variant="p"
